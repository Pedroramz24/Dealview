    ...
    events = [
        {
            ...
            "start_date": (datetime.now(timezone.utc) + timedelta(days=3, hours=10)).isoformat(),
            "end_date": (datetime.now(timezone.utc) + timedelta(days=3, hours=11)).isoformat(),
            "all_day": False,
            "event_type": "meeting",
            "created_at": datetime.now(timezone.utc).isoformat(),
            "updated_at": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "end_date": (datetime.now(timezone.utc) + timedelta(days=7, hours=1)).isoformat(),
            "all_day": True,
            "event_type": "deadline",
            "created_at": datetime.now(timezone.utc).isoformat(),
            "updated_at": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "start_date": (datetime.now(timezone.utc) + timedelta(days=1, hours=14)).isoformat(),
            "end_date": (datetime.now(timezone.utc) + timedelta(days=1, hours=15)).isoformat(),
            "all_day": False,
            "event_type": "followup",
            "created_at": datetime.now(timezone.utc).isoformat(),
            "updated_at": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "start_date": (datetime.now(timezone.utc) + timedelta(days=5, hours=9)).isoformat(),
            "end_date": (datetime.now(timezone.utc) + timedelta(days=5, hours=10)).isoformat(),
            "all_day": False,
            "event_type": "meeting",
            "created_at": datetime.now(timezone.utc).isoformat(),
            "updated_at": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "start_date": (datetime.now(timezone.utc) + timedelta(days=10, hours=18)).isoformat(),
            "end_date": (datetime.now(timezone.utc) + timedelta(days=10, hours=20)).isoformat(),
            "all_day": False,
            "event_type": "meeting",
            "created_at": datetime.now(timezone.utc).isoformat(),
            "updated_at": datetime.now(timezone.utc).isoformat()
