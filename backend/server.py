...
from routes import auth_router, deal_router, dashboard_router as dashboard_routes_router, marketplace_router, messaging_router, onboarding_router, admin_router
...
# Register extracted route modules (auth, deals, dashboard stats/news, marketplace, messaging, onboarding)
