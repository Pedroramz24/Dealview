            ...
            <div className="space-y-2">
              {stages.map((stage, index) => (
                <div
                  key={stage.id}
                  style={{
                    background: editingStage?.id === stage.id ? 'rgba(0, 184, 212, 0.05)' : 'rgba(255,255,255,0.03)',
                    border: editingStage?.id === stage.id ? '1px solid rgba(0, 184, 212, 0.3)' : '1px solid rgba(255,255,255,0.05)',
                    borderRadius: '8px',
                    padding: '12px'
                  }}
                >
