...
**Test Result**: 
```bash
$ curl -H "Authorization: Bearer $TOKEN" https://contact-mgmt-v1.preview.emergentagent.com/api/dashboard/news
HTTP 200 ✅ (was 404 ❌)
```
...
**Test Results**:
```bash
$ curl -H "Authorization: Bearer $TOKEN" https://contact-mgmt-v1.preview.emergentagent.com/api/messages/conversations
HTTP 200 ✅

$ curl -H "Authorization: Bearer $TOKEN" https://contact-mgmt-v1.preview.emergentagent.com/api/messages/unread-count
HTTP 200 ✅
```
